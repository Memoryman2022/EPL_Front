...
const Rules = () => {
  return (
    <div className="Rules-container">
      ...
      <h5>PREDICTING</h5>
      <p>
        Users can access the prediction field by clicking the desired fixture
        accessible through the calendar. <br />
        Each Match Day will be highlighted for User optimisation.
        <br />
        <br />
        Users should input their score in the field provided. When the Predictor
        Icon is activated, that prediction will then be locked in and the
        collective user predictions for that fixture will be displayed.
      </p>
      ...
      <ul>
        ...
        <li>
          Points will be allocated periodically after each Match Days fixtures.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          In the event that total users is greater than 10 the league will split
          after Match Day 19.
        </li>
