  ...
  return (
    <div className="about-page">
      <div className="gif-background">
        <img src="/gifs/Ronny.gif" alt="Ronaldinho" />
      </div>
      <div className="about-content">
        <div className="about-container">
          ...
          <p>
            ...
            , your exclusive platform for predicting Premier League matches!
            Whether you're a casual fan or part of a social group, this app
            provides a fun and engaging way to test your football knowledge and
            compete with friends.
          </p>

          <h5>MISSION</h5>
          <p>
            Our mission is to showcase the stylings and functionality of modern
            web development through a polished, user-friendly application.
            Developed by an independent coder, this project serves as a
            testament to my expanding portfolio and dedication to crafting
          ...
          <p>
            ...
            functional web applications. This project is a key part of my
            portfolio as I work on expanding my skills and showcasing my
            abilities. Thank you. Now get out there and start{" "}
            <strong className="highlighted-text">
              <Link to="/base" className="about-link">
                {" "}
                PREDICTING!{" "}
